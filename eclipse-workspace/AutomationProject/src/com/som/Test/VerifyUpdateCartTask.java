...
public class VerifyUpdateCartTask {
	...
	public void doUpdateShoppingCart() {
		try {
			...
			wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			successMsg = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
					"#layer_cart > div.clearfix > div.layer_cart_product.col-xs-12.col-md-6 > span.title")));
			...
			System.out.println(summaryPage.getText());
			...
			wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			alertMessage = wait
					.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#center_column > p")));
			String removeSuccessMsg = alertMessage.getText();
			System.out.println("Shopping cart is updated by deleting product in cart: " + removeSuccessMsg);
			String expectedMessage = "Your shopping cart is empty.";
			Assert.assertEquals(removeSuccessMsg, expectedMessage);
		} catch (Exception e) {
			System.out.println("print message: " + e);
		}
